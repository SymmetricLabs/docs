...
description: "Learn how to authenticate with the Tesseract Workflow API"
---

## Overview

The Tesseract Workflow API uses API key authentication to secure all endpoints. Each API key is associated with a specific user account and provides access only to that user's workflows and runs.

## Getting Your API Key

<Steps>
  <Step title="Access Your Dashboard">
    Log into your Tesseract dashboard to manage your API keys.
  </Step>
...
```bash
# .env file
TESSERACT_API_KEY=sk_test_1234567890abcdef
```
